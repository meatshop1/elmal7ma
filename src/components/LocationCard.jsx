...
const LocationCard = ({locationSrc, address, time, phoneNum}) => {
  return (
    <div className="w-fit bg-slate-800 m-2 col-span-1 row-span-1 p-2 rounded-lg place-self-center">
      {locationSrc}
      <div className="mt-3">
        <div className="text-2xl w-full m-2 mx-auto flex items-center">
          ...
          <div className="text-xl max-w-[17rem] font-kufam">
            <p className="text-lg">{address.neighborhood}</p>
            <p className="text-lg">{address.street}</p>
            <p className="text-lg">{address.nearTo}</p>
          </div>
        </div>
        <div className="text-2xl w-full m-2 mx-auto flex items-center">
